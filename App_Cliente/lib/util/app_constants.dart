...
import 'package:app_cliente/flavors.dart';
import 'package:app_cliente/util/images.dart';

class AppConstants {
  static String appName = F.appTitle;
  static const double appVersion = 6.3;

  static String baseUrl = F.baseUrl; //'https://delivery.mobilerteste.com.br';
  ...
  /// Deep Links
  //static String yourScheme = F.appTitle;
  //static const String yourHost = 'delivery.mobilerteste.com.br';

  /// Languages

  static List<LanguageModel> languages = [
    LanguageModel(imageUrl: Images.portuguese, languageName: 'Português', countryCode: 'BR', languageCode: 'pt-br'),
    //F.skipLanguage == false ?? LanguageModel(imageUrl: Images.english, languageName: 'English', countryCode: 'US', languageCode: 'en'),
