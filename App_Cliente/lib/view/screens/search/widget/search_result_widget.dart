...
import 'package:app_cliente/view/screens/search/widget/item_view.dart';
...
class SearchResultWidgetState extends State<SearchResultWidget> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      GetBuilder<SearchControll>(builder: (searchController) {
        bool isNull = true;
        int length = 0;
      ...
      Expanded(child: NotificationListener(
        onNotification: (dynamic scrollNotification) {
          if (scrollNotification is ScrollEndNotification) {
            Get.find<SearchControll>().setRestaurant(_tabController!.index == 1);
            Get.find<SearchControll>().searchData(widget.searchText);
          }
          return false;
        },
        child: TabBarView(
