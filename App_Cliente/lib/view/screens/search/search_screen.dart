...
import 'package:app_cliente/view/screens/search/widget/filter_widget.dart';
import 'package:app_cliente/view/screens/search/widget/search_field.dart';
import 'package:app_cliente/view/screens/search/widget/search_result_widget.dart';
...
class SearchScreenState extends State<SearchScreen> {
  ...
  void initState() {
    ...
    if(_isLoggedIn) {
      Get.find<SearchControll>().getSuggestedFoods();
    }
    Get.find<SearchControll>().getHistoryList();
  }
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        if(Get.find<SearchControll>().isSearchMode) {
          return true;
        }else {
          Get.find<SearchControll>().setSearchMode(true);
          return false;
        }
      },
      child: Scaffold(
        ...
        body: SafeArea(child: Padding(
          ...
          child: GetBuilder<SearchControll>(builder: (searchController) {
  ...
  void _actionSearch(SearchControll searchController, bool isSubmit) {
