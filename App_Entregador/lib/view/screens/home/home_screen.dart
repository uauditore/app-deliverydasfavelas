...
import 'package:app_entregador/controller/notification_controller.dart';
...
import 'package:app_entregador/view/base/custom_alert_dialog.dart';
import 'package:app_entregador/view/base/custom_snackbar.dart';
import 'package:app_entregador/view/base/order_shimmer.dart';
import 'package:app_entregador/view/base/order_widget.dart';
import 'package:app_entregador/view/base/title_widget.dart';
import 'package:app_entregador/view/screens/home/widget/count_card.dart';
import 'package:app_entregador/view/screens/home/widget/earning_widget.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: Padding(
          ...
          child: Image.asset('assets/logos/${F.logoImage}', height: 30, width: 30),
        ),
        ...
        title: SizedBox(height: 0), // Image.asset(Images.logo_name, width: 0),
        actions: [
          IconButton(
